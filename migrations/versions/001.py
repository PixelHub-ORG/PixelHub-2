...
def upgrade():
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('type', sa.String(length=50), server_default='pix', nullable=False),
    sa.ForeignKeyConstraint(['ds_meta_data_id'], ['ds_meta_data.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('pix_meta_data',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('games_count', sa.Integer(), nullable=True),
    sa.Column('encoding', sa.String(length=120), nullable=True),
    sa.Column('dataset_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['dataset_id'], ['pix_data_set.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
